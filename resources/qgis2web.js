...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 14, minZoom: 7, projection: new ol.proj.Projection({
            code: 'EPSG:2154',
            extent: [5.146856, 43.110722, 915964.014000, 6248413.000000],
            units: 'm'})
    })
});


map.getView().fit([885783.389577, 6231685.653569, 909370.213084, 6244938.607347], map.getSize());
